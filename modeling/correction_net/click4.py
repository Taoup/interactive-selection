...
class ClickNet(nn.Module):
    ...
    def forward(self, gaussian_center_map, aspp_feat, low_level_feat):
        low_down = F.interpolate(low_level_feat, gaussian_center_map.size()[2:], mode='bilinear', align_corners=True)
        ...
        x1 = torch.cat([gaussian_center_map, aspp_feat, low_down], dim=1)
